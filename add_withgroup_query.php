...
//echo $id;
			...
			foreach($_FILES['memberPic']['tmp_name'] as $key => $tmp_name)
			{
				...
				$path = "assets/img/uploaded_picRegistrant_member/";
       ...
       echo $file_name . "<br>";
			...
			move_uploaded_file($_FILES ['memberPic']['tmp_name'][$key],$target_file . $newfilename3);
			
			$newfilename3 = $file_name . $newfilename3;
      $newfilename3 = substr($newfilename3, 1);
